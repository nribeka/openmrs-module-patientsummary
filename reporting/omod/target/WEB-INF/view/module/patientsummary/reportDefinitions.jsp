...
<openmrs:require privilege="View Patient Summaries" otherwise="/login.htm" 
	redirect="/module/patientsummary/reportDefinitions.list" />

<%@ include file="template/localHeader.jsp"%>

<openmrs:hasPrivilege privilege="Manage Patient Summaries">
	<a href="<openmrs:contextPath />/module/patientsummary/reportDefinitionEditor.form">
...
<script type="text/javascript" charset="utf-8">
	...
	function confirmDelete(name, uuid) {
		if (confirm("Are you sure you want to delete " + name + "?")) {
			document.location.href = '${pageContext.request.contextPath}/module/patientsummary/purgeReportDefinition.form?uuid=' + uuid;
		}
	}
